...
const toggleFinished = (e) => {
  ...
  return (
    <>
      <Navbar />
      <div className="md:container mx-3 md:mx-auto my-5 rounded-xl p-5 bg-violet-100 min-h-[80vh] md:w-[36%]">
      <h1 className='font-bold text-center text-3xl'>iTask - Manage your todos st pne place</h1>
        ...
        <div className="todos">
          ...
          {todos.map(item => {
            ...
            return (showFinished || !item.isCompleted) && <div key={item.id} className="todo flex justify-between flex
             my-3">
